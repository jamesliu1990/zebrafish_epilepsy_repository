...
def plot_intensity(y, SD, label, directory):
   
    x = np.arange(len(y))

    plt.plot(x, y, color='#2F88C0')
    plt.fill_between(x, y-SD, y+SD, alpha=0.5, facecolor='#2F88C0')
...
directories = ['/media/lauderdale/BFR_RAID5/zebrafish_data/wt/20170714_fish2/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/wt/20170714_fish4/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/wt/20170720_fish1/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/wt/20170720_fish2/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/wt/20170720_fish3/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/wt/20170725_fish1/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/wt/20170725_fish2/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/ptz/20170628_fish1/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/ptz/20170629_fish1/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/ptz/20170629_fish2/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/ptz/20170810_fish1/gfp_separated',\
               '/media/lauderdale/BFR_RAID5/zebrafish_data/ptz/20180116_fish1/gfp_separated']
...
for directory in directories:
    ...
    arr_size = len(nonzero_intensities)
    video_sum_SD = np.zeros(arr_size)
    video_sum_SD[0] = np.std(nonzero_intensities)
    video_sum_avg = np.zeros(arr_size)
    video_sum_avg[0] = np.mean(remove_zeros(intensities))
    video_avg = np.zeros(arr_size)
    ...
    plot_intensity(nonzero_intensities, SD_sum, 'Sum_of_' + make_label(directory), directory)
    plot_intensity(avg_intensities, SD_avg, 'Avg_of_' + make_label(directory), directory)
    plot_intensity(nonzero_intensities, np.std(nonzero_intensities), 'Summation_of_' + make_label(directory) + '_Total_Error', directory)
    plot_intensity(avg_intensities, np.std(avg_intensities), 'Averages_of_' + make_label(directory) + '_Total_Error', directory)
